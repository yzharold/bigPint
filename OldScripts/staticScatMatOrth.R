#' Scatterplot matrix of orthogonal values
#' 
#' Scatterplot matrix with orthogonal values.
#' @param data data frame
#' @param threshOrth threshold of orthogonal (default 3)
...
#' data(soybean_cn)
#' data = soybean_cn
#' staticScatMatOrth(data, threshOrth=5)
staticScatMatOrth= function(data, pointSize=1, threshOrth=3, outDir=getwd()){
